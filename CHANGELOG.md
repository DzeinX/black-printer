## [2.3.1] - 2024-05-03
### Added
- Добавлен функционал для отмены учёта картриджей и принтеров, которые были отправлены по ошибке
- Добавлен поиск по локации для картриджей и принтеров
- Было добавлено автозаполнение местоположения для принтера
- Новая галочка для отмены показа "Жёлтого" сообщения ответственности за здание
## [2.3.0] - 2024-06-02
### Bags
- Исправлена ошибка с CRUD вкладки администрирование
## [2.2.0] - 2024-26-01
### Added
